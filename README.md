...
Abstract: Reconstructing dynamic scenes from monocular videos remains a challenging problem due to motion modeling methods generally suffering from temporal instability, boundary artifacts, or geometric collapse. 
